...
parser.add_argument('--maf', help = 'Multiple sequence alignment in multiple alignment format (MAF)')
...
parser.add_argument('--score', help = 'Minimum sequence identity of a candidate conserved element', type = int, default = 70)
parser.add_argument('--length', help = 'Minimum length of a candidate conserved element', type = int, default = 50)
