...
parser.add_argument('--cov', help = 'Directory to all coverage files as generated by maf_stream coverage')
...
def plot_coverage(coverage, mygroup, path, species_name):
	...
	plt.ylabel('Coverage %')
	colors = ['#2f6694' if x == 'Moth' else '#ff8000' for x in list_group]
